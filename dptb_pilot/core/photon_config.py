...
import os
from dptb_pilot.core.photon_service import PhotonChargeConfig
...
PHOTON_CONFIG = PhotonChargeConfig(
    ...
    # 客户端名称（默认值，实际使用时会从 cookie 中获取 clientName）
    client_name=os.getenv("PHOTON_CLIENT_NAME", "DeepTBPilot"),
